...
document.addEventListener('DOMContentLoaded', function() {
  ...
  console.log('Watch Trailer Button found:', gameButton);
  if (gameButton) {
    gameButton.addEventListener('click', (e) => {
      ...
      console.log('Trailer section found:', trailerSection);
      if (trailerSection) {
  ...
  console.log('Steam Button found:', steamButton);
  if (steamButton) {
    steamButton.addEventListener('click', (e) => {
      ...
      // Log for analytics
      console.log('Navigating to Steam store...');
    });
  }
